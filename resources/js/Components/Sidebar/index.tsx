...
const Sidebar = ({ sidebarOpen, setSidebarOpen, sidebarDesktopOpen, setSidebarDesktopOpen }: SidebarProps) => {
  ...
  return (
    <div>
                          ...
                          <ul role="list" className="-mx-2 space-y-1">
                            ...
                            auth.menu?.filter((m: any) => m.menu_parent_id === null).map((menu: any, index: number) => {
                              ...
                              menu.menu_url !== null ?
                                ...
                                <SidebarLinkGroup
                                  activeCondition={
                                    pathname.includes(menu.menu_name.toLowerCase())
                                  }
                                  key={index}
                                >
                                  {(handleClick, open) => {
                                        ...
                                        >
                                          <ul className="mt-2 flex flex-col pl-6">
                                          {
                                            menu.children?.filter((children: any) => {
                                              ...
                                              <li key={index}>
                                                <NavLink
                                                  href={route(filteredChildren.menu_url)} active={route().current(filteredChildren.menu_url)}
        ...
        <div className={`hidden lg:fixed lg:inset-y-0 lg:z-50 ${!sidebarDesktopOpen?'lg:flex lg:w-72 lg:flex-col':''}`}>
          {/* Sidebar component, swap this element with another sidebar if you like */}
