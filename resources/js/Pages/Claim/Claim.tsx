                    ...
                    <>
                        ...
                        <div className="h-auto p-4 ">
                            <fieldset className=" sm:flex sm:flex-col sm:gap-4 lg:flex lg:flex-row lg:gap-2 border border-gray-400 px-4 rounded-md w-full mt-2 ">
                                <legend className="text-lg font-semibold px-2 text-gray-600">
                                    Claim Info
                                </legend>
                                <div className="sm:w-full lg:w-full ">
                                    ...
                                    <div className="flex gap-2 justify-between p-2">
                                        ...
                                        <div className=" flex gap-2 justify-center p-2 rounded-md text-gray-500 hover:text-red-400 cursor-pointer"
                                    ...
                                    <fieldset className="mt-1 p-4 justify-end border border-gray-400 rounded-md">
                                                                            ...
                                                                            return (
                                                                                <>
                                                                                    <div className="px-4 mt-2 ">
                                                                                        ...
                                                                                        {el?.insured?.map((el: any, index: number) => {
                                                                                            return (
                                                                                                <div className={`rounded-md px-4 mt-3 p-2 h-10 ${index % 2 === 0 ? 'bg-slate-200' : ''}`}>
                                                                                                    - {el.claim_coverage.interest_insured.INTEREST_INSURED_NAME}
                                                                                                </div>)
                                                                                        })
                                                                                        }
                                                                                    </div>
                                                            ...
                                                            <>
                                                                <div className="mt-2 mb-4">
                                                                    <div className=" flex flex-row justify-center gap-2 bg-slate-200 border-gray-300 border rounded-md w-full p-4 h-24 text-2xl font-sans text-center items-center font-medium   ">
                                                                        ...
                                                                        {
                                                                            dataId.coverage?.map((el: any) => {
                                                                                const sumValue = el?.insured?.reduce((acc: any, insured: any) => {
                                                                                    const value = insured?.VALUE_SUBMIT_COVERAGE;
                                                                                    // Pastikan nilai VALUE_SUBMIT_COVERAGE adalah angka
                                                                            ...
                                                                            return (
                                                                                <>
                                                                                    <div className="px-4 mt-2 text-center ">
                                                                                        ...
                                                                                        <div className="">{el?.insured?.map((el: any, index: any) => {
                                                                                            return (
                                                                                                <>
                                                                                                    <div className={` rounded-md flex justify-between px-4 mt-3 p-2 h-10 ${index % 2 === 0 ? 'bg-slate-200' : ''}`}>
                                                                                                        <div className="">{currency}</div>
                                                                                                        <div className="">{el?.VALUE_SUBMIT_COVERAGE}</div>
                                                                                                        <div className="text-gray-500 text-sm flex italic hover:text-red-400 cursor-pointer"
                                                                                                            onClick={(e) => {
                                                                                                                // update value
                                                                                                                valueRevChange(e, el)
                        ...
                        <ActionModal
                            ...
                            onClose={() => setModal({ ...modal, updateValue: false, edit: true })}
                            data={valueRev}
