...
export default function DetailEmployeeAddress({
    idEmployee,
    wilayah,
    wilayahSelect,
    setIsSuccess,
    ...
    useEffect(() => {
        getEmployeeAddress(idEmployee);
    }, [idEmployee]);
    const [isSuccessEditAddress, setIsSuccessEditAddress] =
        useState<string>("");
    ...
    const getEmployeeAddress = async (id: string) => {
        await axios
    ...
    const handleSuccessEditAddress = (message: string) => {
        setIsSuccessEditAddress("");
        if (message != "") {
            setIsSuccessEditAddress(message[1]);
            getEmployeeAddress(idEmployee);
            setTimeout(() => {
                setIsSuccessEditAddress("");
            }, 5000);
    ...
    return (
        <>
            {isSuccessEditAddress && (
                <ToastMessage
                    message={isSuccessEditAddress}
                    isShow={true}
                    type={"success"}
                />
            )}
