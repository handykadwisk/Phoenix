    ...
    return (
        <>
            ...
            <ModalToAdd
                ...
                classPanel={"relative transform overflow-hidden rounded-lg bg-red-900 text-left shadow-xl transition-all sm:my-4 sm:w-full sm:max-w-lg lg:max-w-4xl"}
                body={<>
                                    ...
                                    <div className="grid grid-cols-5 mb-4">
                                        ...
                                        <div className="col-span-3">
                                            <TextInput
                                                ...
                                                type="text"
                                                name="coverage_name"
                                                value={insured.POLICY_COVERAGE_NAME}
                                                className=""
                                                autoComplete="coverage_name"
                                                onChange={(e) => inputDataInsured(
                                                    "POLICY_COVERAGE_NAME",
                                                    e.target.value,
                                                    i
                                                )}
