...
CREATE TABLE `r_cash_advance_differents` (
  ...
  `CASH_ADVANCE_DIFFERENTS_NAME` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
insert  into `r_cash_advance_differents`(`CASH_ADVANCE_DIFFERENTS_ID`,`CASH_ADVANCE_DIFFERENTS_NAME`,`CASH_ADVANCE_DIFFERENTS_CREATED_AT`,`CASH_ADVANCE_DIFFERENTS_UPDATED_AT`) values (1,'Refund to Fresnel',NULL,NULL),(2,'Devisit to be Fresnel',NULL,NULL);
